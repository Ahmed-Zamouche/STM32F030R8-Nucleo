##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.26.0] date: [Mon Feb 19 23:16:07 CET 2018] 
##########################################################################################################################
...
include mk/thirdparty/microshell.mk
include mk/help.mk
...
#######################################
unittest: library
	"$(MAKE)" -f Unittest/unittest.mk
unittest_flash: unittest
	"$(MAKE)" -f Unittest/unittest.mk flash
unittest_debug: unittest_flash
	"$(MAKE)" -f Unittest/unittest.mk debug
unittest_clean:
	"$(MAKE)" -f Unittest/unittest.mk clean

#######################################
# microshell flash / debug
#######################################
microshell: library
	"$(MAKE)" -f Mains/microshell.mk
microshell_flash: microshell
	"$(MAKE)" -f Mains/microshell.mk flash
microshell_debug: microshell_flash
	"$(MAKE)" -f Mains/microshell.mk debug
microshell_clean:
	"$(MAKE)" -f Mains/microshell.mk clean
